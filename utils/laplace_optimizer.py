...
def minimize_laplacian_energy(vertices, faces, L, num_iters=250, eta=0.001, expand_neighborhood=False, is_hessian_energy=False):
    """
    ...
    if(expand_neighborhood == True):
        ...
        cells = torch.from_numpy(faces).long()
    V = vertices.clone()
