...
class SHINEConfig:
    def __init__(self):
        ...
        self.hessian_loss_on: bool = False
        self.weight_h: float = 0.1
        self.hessian_loss_scale: float = 7e-12
        self.hessian_norm_scale: float = 7e-9
        ...
        self.laplacian_optimization: bool = True # use laplacian optimization to smooth the mesh or not
    ...
    def load(self, config_file):
        ...
        self.hessian_loss_on = config_args["loss"]["hessian_loss_on"] # use hessian loss (gradient norm = 1) or not
        self.weight_h = float(config_args["loss"]["weight_h"]) # weight for the hessian loss
        self.hessian_loss_scale = float(config_args["loss"]["hessian_loss_scale"]) # scale for the hessian loss
        self.hessian_norm_scale = float(config_args["loss"]["hessian_norm_scale"]) # scale for the hessian norm loss
        ...
        self.laplacian_optimization = config_args["eval"]["laplacian_optimization"] # use laplacian optimization to smooth the mesh or not
